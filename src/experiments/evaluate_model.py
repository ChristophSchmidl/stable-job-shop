...
from src.old_utils import evaluate_policy_with_makespan
...
def make_jobshop_env(rank=0, seed=0, instance_name="taillard/ta41.txt", monitor_log_path=None):
    ...
    """
    env = gym.make('jss-v1', env_config={'instance_path': f"./data/instances/{instance_name}", 'permutation_mode': False})
